...
# ── Root directories ──────────────────────────────────────────────────────────
BACKEND_DIR          = Path(__file__).resolve().parent.parent   # d:/AIOps_Incident_Management/backend
APP_DATA_DIR         = BACKEND_DIR / "app_data_generator"
...
# __ DEVOPS SeverityEngine (legacy path for severity_node.py) _________________
DEVOPS_DIR            = BACKEND_DIR.parent / "DEVOPS"
SEVERITY_THRESHOLDS   = DEVOPS_DIR / "severity_config" / "thresholds.yaml"
